...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { cost: @donut.cost, dough: @donut.dough, filling: @donut.filling, image: @donut.image, name: @donut.name, toppings: @donut.toppings }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { cost: @donut.cost, dough: @donut.dough, filling: @donut.filling, image: @donut.image, name: @donut.name, toppings: @donut.toppings }
    assert_redirected_to donut_path(assigns(:donut))
  end
